...
export function BetDisplay() {
  ...
  return (
    <div className="text-center">
      <div className={`text-5xl font-bold font-mono ${bet.hasEdge ? 'text-green-300' : effectiveBet <= minBet ? 'text-neutral-600' : effectiveBet <= 10 ? 'text-neutral-300' : 'text-amber-300'}`}>
